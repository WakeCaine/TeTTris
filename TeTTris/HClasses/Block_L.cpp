...
Block_L :: Block_L(sf::RenderWindow& oknoAplikacji): okno(oknoAplikacji)
{
	position=1;
	opoznienie=0;
...
int Block_L :: returnPosition(char character, int k)
{
	if(character=='x')
		return posX[k];
	else
...
void Block_L :: Move(GameMap* mapka)
{
